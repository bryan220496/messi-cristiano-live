...
export default function App(){
  ...
  useEffect(()=>{
    ...
    const connect=()=>{
      ...
      try{
        ...
        socket.onmessage=e=>{try{const d=JSON.parse(e.data); if(d.type==='gift') reactToGift(d.gift,d.quantity||1,d.user||'Espectador')}catch{}};
        ws.current=socket;
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="light"/><ScrollView contentContainerStyle={styles.container}>
    ...
    {tab==='battle' && <>
      ...
      <View style={styles.artBox}><Image source={require('./assets/game-art.png')} style={styles.art}/></View>
